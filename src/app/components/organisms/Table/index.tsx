...
export default function Table() {
    ...
    const handleDeleteProduct = (product: Produto) => {
        toast(
            <div className="flex flex-col justify-center items-center py-2 gap-4">
                <p className="text-lg font-semibold text-gray-800 text-center">Tem certeza que deseja excluir este produto?</p>
    ...
    return (
        <div className="my-4 w-full">
            ...
            <Modal isOpen={!!selectedProduct && !isEditModalOpen} onClose={handleCloseModal}>
                {selectedProduct && (
                    <>
